<x-app-layout>
    <div class="py-12 mt-2">
        ...
        <div class="flex justify-between">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Data Pasien</h1>
                ...
                @forelse ($daftarPasien as $pasien)
                    <tr
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('admin.pasien.edit', ['pasien' => $pasien->id]) }}"
                            ...
                            <form action="{{ route('admin.pasien.destroy', ['pasien' => $pasien->id]) }}" method="POST"
                                class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
