<x-app-layout>
    <div class="py-12 mt-2">
        ...
        <form method="POST" action="{{ route('admin.poli.update', ['poli' => $poli->id]) }}">
            @csrf
            @method('PUT')

            <div class="mb-5">
                <label for="nama_poli" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                <input type="text" id="nama_poli" name="nama_poli" value="{{ $poli->nama_poli }}"
                    autofocus
            ...
            <div class="mb-5">
                ...
                <input type="text" id="keterangan" name="keterangan" value="{{ $poli->keterangan }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
