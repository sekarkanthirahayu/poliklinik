<x-app-layout>
    <div class="py-12 mt-2">
        ...
        <div class="flex justify-between">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Data Poli</h1>
                ...
                @forelse ($daftarPoli as $poli)
                    <tr
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('admin.poli.edit', ['poli' => $poli->id]) }}"
                            ...
                            <form action="{{ route('admin.poli.destroy', ['poli' => $poli->id]) }}" method="POST"
                                class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
